        ...
        <Route
          ...
          element={
            <ViewEditContainer
              ...
              Details={
                Details ||
                ((p) => <Form initialValues={p.detailedRecord} {...p} />)
              }
              routeBase={routeBase}
              onlyDiff={onlyDiff}
              canRemove={props.canRemove}
          ...
          <Card p={6}>
            ...
            >
              <HStack justify="space-between">
                <HStack>
                  {!title.localeCompare("Meu Registo", undefined, {
                    sensitivity: "base",
                  }) === 0 && (
                  ...
                  onSubmit={async (values) => {
                    try {
                      const result = await update(
                        id,
                        onlyDiff ? diff(detailedRecord, values) : values
                      );
                      setIsEditing(false);
                      navigate("..");
                      toast({
